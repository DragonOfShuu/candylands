...
public class MainBlocks {
    ...
    public static final DeferredBlock<Block> LICORICE_WOOD = registerBlock("licorice_wood",
    ...
    public static final DeferredBlock<Block> LICORICE_PRESSURE_PLATE = registerBlock("licorice_pressure_plate",
            ...
            () -> BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PRESSURE_PLATE).mapColor(MapColor.COLOR_PINK));
    ...
    public static final DeferredBlock<Block> LICORICE_FENCE_GATE = registerBlock("licorice_fence_gate",
            ...
            () -> BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_FENCE_GATE).mapColor(MapColor.COLOR_PINK));
