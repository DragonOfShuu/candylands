...
public class CandyVerticalSpread extends MemoizedSpreadBlock {
    public static final MapCodec<CandyVerticalSpread> CODEC = RecordCodecBuilder
            .mapCodec((p_432677_) -> {
                return p_432677_.group(ResourceKey.codec(Registries.BIOME)
                        .fieldOf("biome").forGetter((p_304391_) -> {
                            return p_304391_.biome;
                        }), propertiesCodec())
                        .apply(p_432677_, CandyVerticalSpread::new);
            });

    private final ResourceKey<Biome> biome;

    public CandyVerticalSpread(ResourceKey<Biome> biome,
    ...
    protected void spreadTick(BlockState state, ServerLevel level, BlockPos pos,
        ...
        MainSpreadFunctions.CANDY_VERTICAL_ONLY_SPREAD.get().tick(state, level,
                pos, cantSpreadHook, (c) -> {
                }, random);
    }
}
