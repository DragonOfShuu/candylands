...
public class MainBlockTagsProvider extends BlockTagsProvider {
    public MainBlockTagsProvider(PackOutput output,
    ...
    private void mineableTags() {
        tag(BlockTags.SWORD_EFFICIENT).add(MainBlocks.LICORICE_LEAVES.get());

        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                .addAll(MainBlockFamilies.getStoneBlockFamilies().flatMap(
        ...
        tag(BlockTags.NEEDS_STONE_TOOL).add(MainBlocks.CANDY_GRASS_BLOCK.get())
                .add(MainBlocks.CANDY_DIRT_BLOCK.get())
                .add(MainBlocks.CANDY_CANE_ROCK.get())
                .add(MainBlocks.CANDY_CANE_COBBLESTONE.get());
    }
    ...
    private void blockTagTypes() {
        ...
        tag(BlockTags.LEAVES).add(MainBlocks.LICORICE_LEAVES.get());
        ...
        tag(BlockTags.WOODEN_BUTTONS).addAll(MainBlockFamilies
                .getVariantFromWoodBlockFamilies(Variant.BUTTON));

        tag(BlockTags.WOODEN_PRESSURE_PLATES).addAll(MainBlockFamilies
                .getVariantFromWoodBlockFamilies(Variant.PRESSURE_PLATE));

        tag(BlockTags.FENCES).addAll(
                MainBlockFamilies.getVariantFromBlockFamilies(Variant.FENCE));

        tag(Tags.Blocks.FENCES).addAll(
                MainBlockFamilies.getVariantFromBlockFamilies(Variant.FENCE));

        tag(BlockTags.WOODEN_FENCES).addAll(MainBlockFamilies
                .getVariantFromWoodBlockFamilies(Variant.FENCE));

        tag(Tags.Blocks.FENCES_WOODEN).addAll(MainBlockFamilies
                .getVariantFromWoodBlockFamilies(Variant.FENCE));

        tag(BlockTags.FENCE_GATES).addAll(MainBlockFamilies
                .getVariantFromBlockFamilies(Variant.FENCE_GATE));

        tag(BlockTags.UNSTABLE_BOTTOM_CENTER).addAll(MainBlockFamilies
                .getVariantFromBlockFamilies(Variant.FENCE_GATE));

        tag(Tags.Blocks.FENCE_GATES).addAll(MainBlockFamilies
                .getVariantFromBlockFamilies(Variant.FENCE_GATE));

        tag(Tags.Blocks.FENCE_GATES_WOODEN).addAll(MainBlockFamilies
                .getVariantFromWoodBlockFamilies(Variant.FENCE_GATE));

        tag(BlockTags.WOODEN_SLABS).addAll(MainBlockFamilies
                .getVariantFromWoodBlockFamilies(Variant.SLAB));

        tag(BlockTags.WOODEN_STAIRS).addAll(MainBlockFamilies
                .getVariantFromWoodBlockFamilies(Variant.STAIRS));
