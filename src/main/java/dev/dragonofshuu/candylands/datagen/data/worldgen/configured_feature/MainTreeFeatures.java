...
public class MainTreeFeatures {
    ...
    // Block logBlock, Block leavesBlock, int baseHeight, int
    // heightRandA, int
    // heightRandB, int radius) {
    // return new TreeConfiguration.TreeConfigurationBuilder(
    // BlockStateProvider.simple(logBlock),
    // new StraightTrunkPlacer(baseHeight, heightRandA,
    // heightRandB),
    ...
    private static TreeConfiguration.TreeConfigurationBuilder cherry(
        ...
        return new TreeConfiguration.TreeConfigurationBuilder(
                ...
                new CherryTrunkPlacer(7, 1, 0,
                        ...
                        UniformInt.of(-1, 0)),
                BlockStateProvider.simple(leavesBlock),
                new CherryFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0),
                        ConstantInt.of(5), 0.25F, 0.5F, 0.16666667F,
                        0.33333334F),
