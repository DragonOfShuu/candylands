...
public class MainPlacedVegetationFeatures {
    public static final ResourceKey<PlacedFeature> TREES_CANDY = MainPlacedFeatures.createKey("trees_candy");
    ...
    public static void register(BootstrapContext<PlacedFeature> bootstrap,
        ...
        var candyTrees = configuredFeatureHolder.getOrThrow(MainVegetationFeatures.TREES_CANDY);
